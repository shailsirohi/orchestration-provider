...
// +kubebuilder:resource:scope=Cluster,categories={crossplane,provider,orchestrator}
...
var (
	...
	ProviderConfigUsagGroupVersionKind = SchemeGroupVersion.WithKind(ProviderConfigUsageKind)
